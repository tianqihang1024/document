...
```shell
$ docker run -d --name seata --restart=always -p 8091:8091 --network docker_net --ip 172.18.0.6 -e JVM_XMS=516m -e JVM_XMX=516m -e SEATA_IP=81.70.96.232 -e SEATA_PORT=8091 seataio/seata-server:1.3.0
...
store {
  ...
  db {
    ...
    url = "jdbc:mysql://bj-cdb-6r45n79k.sql.tencentcdb.com:60062/seata?characterEncoding=utf8&useSSL=false&serverTimezone=UTC&rewriteBatchedStatements=true"
    user = "root"
